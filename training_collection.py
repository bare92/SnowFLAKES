...
def collect_trainings(curr_acquisition, curr_aux_folder, auxiliary_folder_path, SVM_folder_name, no_data_mask, bands,
    ...
    for curr_range, sample_count in range_samples.items():
        ...
        if curr_range[0] >= 90:
            # Normalize indices and compute shadow metric
            representative_pixels_mask_snow, representative_pixels_mask_noSnow = compute_representative_snow_pixels_high_range(curr_NDSI,
                                                                                                                               curr_bands,
                                                                                                                               curr_diff_B_NIR,
                                                                                                                               curr_distance_idx,
                                                                                                                               curr_shad_idx,
            ...
            representative_pixels_mask_snow, representative_pixels_mask_noSnow  = compute_representative_snow_pixels(
                curr_NDSI, curr_NDVI, curr_bands, curr_distance_idx, curr_green, sample_count)
